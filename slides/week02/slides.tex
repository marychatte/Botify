...
Улучшить пользовательский опыт & & & & & \checked \\
Добиться большей лояльности & & & & & \checked \\
Лучше понимать пользователей & & & & & \checked \\
\hline
{\bf Пользователям} & & & & & \\
\hline
Найти лучший товар & & & & & \checked \\
Найти {\bf все} подходящие товары & & & & & \checked \\
Найти последовательность или набор товаров & & & & & \checked \\
Залипнуть & & & & & \checked \\
